...
from openai_utils import summarize_text, ask_question  # Changed import

# --- Page Configuration ---
st.set_page_config(page_title="DocuDroid AI", layout="wide")
...
<div class="title-card">
    <div class="title">Docudroid AI</div>
